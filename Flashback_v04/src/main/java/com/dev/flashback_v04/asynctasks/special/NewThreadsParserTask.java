 ...
 */
public class NewThreadsParserTask extends AsyncTask<String, String, ArrayList<Item_CurrentThreads>> {
    ...
    public NewThreadsParserTask(UpdateStuff fetchComplete, Context context) {
